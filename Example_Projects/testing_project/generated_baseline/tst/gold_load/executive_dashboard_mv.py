...
FROM acme_edw_tst.edw_gold.sales_summary_monthly_mv
"""
    )
...
FROM acme_edw_tst.edw_gold.revenue_by_region_mv
GROUP BY month
"""
    )
...
FROM acme_edw_tst.edw_gold.customer_lifetime_value_mv
"""
    )
...
def executive_dashboard_mv():
    """Write to acme_edw_tst.edw_gold.executive_dashboard_mv from multiple sources"""
