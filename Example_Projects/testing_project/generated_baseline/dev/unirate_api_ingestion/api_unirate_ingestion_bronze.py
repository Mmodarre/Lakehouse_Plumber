...
# ============================================================================
# The following code was automatically copied from: /Users/mehdi.modarressi/Documents/Coding/Lakehouse_Plumber/tests/e2e/fixtures/testing_project/data_sources/currency_api_source.py
...
class CurrencyAPIStreamingReader(DataSourceStreamReader):
    ...
    def _load_progress(self):
        ...
        if response.status_code == 200:
            ...
            print(
                f"✅ Loaded progress: last call at {self.last_api_call_time}, total calls: {self.total_api_calls}"
            )
        else:
    ...
    def _should_make_api_call(self):
        ...
        if not should_call:
            ...
            print(
                f"⏳ Skipping API call - {remaining_time} seconds remaining until next allowed call"
            )
...
dlt.create_streaming_table(
    name="acme_edw_dev.edw_bronze.currency_exchange",
...
@dlt.append_flow(
    target="acme_edw_dev.edw_bronze.currency_exchange",
    name="f_currency_exchange_bronze",
    comment="Append flow to acme_edw_dev.edw_bronze.currency_exchange",
)
def f_currency_exchange_bronze():
    """Append flow to acme_edw_dev.edw_bronze.currency_exchange"""
    # Streaming flow
