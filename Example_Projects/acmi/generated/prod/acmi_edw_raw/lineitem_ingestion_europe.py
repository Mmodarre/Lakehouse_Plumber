...
def v_lineitem_europe_raw_cloudfiles():
    ...
    df = (
        ...
        .load(
            "/Volumes/acme_edw_prod/edw_raw/incoming_volume/lineitem/region_EUROPE/*.parquet"
        )
    )
...
dlt.create_streaming_table(
    name="acme_edw_prod.edw_raw.lineitem_europe_raw",
...
@dlt.append_flow(
    target="acme_edw_prod.edw_raw.lineitem_europe_raw",
    name="f_lineitem_europe_raw_cloudfiles",
    comment="Append flow to acme_edw_prod.edw_raw.lineitem_europe_raw",
)
def f_lineitem_europe_raw_cloudfiles():
    """Append flow to acme_edw_prod.edw_raw.lineitem_europe_raw"""
    # Streaming flow
