...
def v_customer_raw_cloudfiles():
    ...
    df = (
        ...
        .load("/Volumes/acme_edw_prod/edw_raw/incoming_volume/customer/*.csv")
    )
...
dlt.create_streaming_table(
    name="acme_edw_prod.edw_raw.customer_raw",
...
@dlt.append_flow(
    target="acme_edw_prod.edw_raw.customer_raw",
    name="f_customer_raw_cloudfiles",
    comment="Append flow to acme_edw_prod.edw_raw.customer_raw",
)
def f_customer_raw_cloudfiles():
    """Append flow to acme_edw_prod.edw_raw.customer_raw"""
    # Streaming flow
