...
def v_nation_raw_cloudfiles():
    ...
    df = (
        ...
        .load("/Volumes/acme_edw_prod/edw_raw/incoming_volume/nation/*.parquet")
    )
...
dlt.create_streaming_table(
    name="acme_edw_prod.edw_raw.nation_raw", comment="Streaming table: nation_raw"
)


# Define append flow(s)
@dlt.append_flow(
    target="acme_edw_prod.edw_raw.nation_raw",
    name="f_nation_raw_cloudfiles",
    comment="Append flow to acme_edw_prod.edw_raw.nation_raw",
)
def f_nation_raw_cloudfiles():
    """Append flow to acme_edw_prod.edw_raw.nation_raw"""
    # Streaming flow
