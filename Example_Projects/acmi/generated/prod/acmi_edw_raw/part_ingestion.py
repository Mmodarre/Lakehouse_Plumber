...
def v_part_raw_cloudfiles():
    ...
    df = (
        ...
        .load("/Volumes/acme_edw_prod/edw_raw/incoming_volume/part/*.json")
    )
...
dlt.create_streaming_table(
    name="acme_edw_prod.edw_raw.part_raw", comment="Streaming table: part_raw"
)


# Define append flow(s)
@dlt.append_flow(
    target="acme_edw_prod.edw_raw.part_raw",
    name="f_part_raw_cloudfiles",
    comment="Append flow to acme_edw_prod.edw_raw.part_raw",
)
def f_part_raw_cloudfiles():
    """Append flow to acme_edw_prod.edw_raw.part_raw"""
    # Streaming flow
