...
def v_partsupp_raw_cloudfiles():
    ...
    df = (
        ...
        .load("/Volumes/acme_edw_prod/edw_raw/incoming_volume/partsupp/*.parquet")
    )
...
dlt.create_streaming_table(
    name="acme_edw_prod.edw_raw.partsupp_raw", comment="Streaming table: partsupp_raw"
)


# Define append flow(s)
@dlt.append_flow(
    target="acme_edw_prod.edw_raw.partsupp_raw",
    name="f_partsupp_raw_cloudfiles",
    comment="Append flow to acme_edw_prod.edw_raw.partsupp_raw",
)
def f_partsupp_raw_cloudfiles():
    """Append flow to acme_edw_prod.edw_raw.partsupp_raw"""
    # Streaming flow
