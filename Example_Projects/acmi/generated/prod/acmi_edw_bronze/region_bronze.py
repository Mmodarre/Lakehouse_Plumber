...
dlt.create_streaming_table(
    name="acme_edw_prod.edw_bronze.region",
...
@dlt.append_flow(
    target="acme_edw_prod.edw_bronze.region",
    name="f_region_bronze_incremental",
    comment="Append flow to acme_edw_prod.edw_bronze.region",
)
def f_region_bronze_incremental():
    """Append flow to acme_edw_prod.edw_bronze.region"""
    # Streaming flow
