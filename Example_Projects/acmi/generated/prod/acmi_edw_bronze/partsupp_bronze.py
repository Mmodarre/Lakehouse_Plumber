...
def v_partsupp_raw():
    ...
    df = spark.readStream.table("acme_edw_prod.edw_raw.partsupp_raw")
...
def v_partsupp_migration():
    ...
    df = spark.read.table("acme_edw_prod.edw_old.partsupp")
...
dlt.create_streaming_table(
    name="acme_edw_prod.edw_bronze.partsupp",
...
@dlt.append_flow(
    target="acme_edw_prod.edw_bronze.partsupp",
    name="f_partsupp_bronze_incremental",
    comment="Append flow to acme_edw_prod.edw_bronze.partsupp",
)
def f_partsupp_bronze_incremental():
    """Append flow to acme_edw_prod.edw_bronze.partsupp"""
    # Streaming flow
