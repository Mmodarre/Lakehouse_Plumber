...
dlt.create_streaming_table(
    name="acme_edw_prod.edw_bronze.customer",
...
@dlt.append_flow(
    target="acme_edw_prod.edw_bronze.customer",
    name="f_customer_migration",
    once=True,
    comment="Append flow to acme_edw_prod.edw_bronze.customer",
)
def f_customer_migration():
    """Append flow to acme_edw_prod.edw_bronze.customer"""
