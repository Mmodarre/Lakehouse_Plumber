...
def v_nation_raw():
    ...
    df = spark.readStream.table("acme_edw_tst.edw_raw.nation_raw")
...
dlt.create_streaming_table(
    name="acme_edw_tst.edw_bronze.nation", comment="Streaming table: nation"
)


# Define append flow(s)
@dlt.append_flow(
    target="acme_edw_tst.edw_bronze.nation",
    name="f_nation_bronze_incremental",
    comment="Append flow to acme_edw_tst.edw_bronze.nation",
)
def f_nation_bronze_incremental():
    """Append flow to acme_edw_tst.edw_bronze.nation"""
    # Streaming flow
