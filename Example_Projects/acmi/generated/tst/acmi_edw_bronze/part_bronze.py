...
def v_part_raw():
    ...
    df = spark.readStream.table("acme_edw_tst.edw_raw.part_raw")
...
def v_part_migration():
    ...
    df = spark.read.table("acme_edw_tst.edw_old.part")
...
dlt.create_streaming_table(
    name="acme_edw_tst.edw_bronze.part",
...
@dlt.append_flow(
    target="acme_edw_tst.edw_bronze.part",
    name="f_part_bronze_incremental",
    comment="Append flow to acme_edw_tst.edw_bronze.part",
)
def f_part_bronze_incremental():
    """Append flow to acme_edw_tst.edw_bronze.part"""
    # Streaming flow
