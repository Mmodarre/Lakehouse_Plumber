...
def v_supplier_raw():
    ...
    df = spark.readStream \
        .table("acme_edw_dev.edw_raw.supplier_raw")
...
def v_supplier_migration():
    ...
    df = spark.read.table("acme_edw_dev.edw_old.supplier")
...
dlt.create_streaming_table(
    name="acme_edw_dev.edw_bronze.supplier",
...
@dlt.append_flow(
    target="acme_edw_dev.edw_bronze.supplier",
    name="f_supplier_bronze_incremental",
    comment="Append flow to acme_edw_dev.edw_bronze.supplier"
)
def f_supplier_bronze_incremental():
    """Append flow to acme_edw_dev.edw_bronze.supplier"""
    # Streaming flow
...
once=True,    comment="Append flow to acme_edw_dev.edw_bronze.supplier"
)
