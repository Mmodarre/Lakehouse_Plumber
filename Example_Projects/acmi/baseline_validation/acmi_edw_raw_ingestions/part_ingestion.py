...
def v_part_raw_cloudfiles():
    """Load part_raw Parquet files from landing volume"""
    df = spark.readStream \
        .format("cloudFiles") \
...
dlt.create_streaming_table(
    name="acmi_edw_dev.edw_raw.part_raw",
    comment="Streaming table: part_raw")


# Define append flow(s)
@dlt.append_flow(
    target="acmi_edw_dev.edw_raw.part_raw",
    name="f_part_raw_cloudfiles",
    comment="Append flow to acmi_edw_dev.edw_raw.part_raw"
)
def f_part_raw_cloudfiles():
    """Append flow to acmi_edw_dev.edw_raw.part_raw"""
    # Streaming flow
