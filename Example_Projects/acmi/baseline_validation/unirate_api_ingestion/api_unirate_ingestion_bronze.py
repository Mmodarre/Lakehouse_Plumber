...
dlt.create_streaming_table(
    name="acmi_edw_dev.edw_bronze.currency_exchange",
    comment="Streaming table: currency_exchange")


# Define append flow(s)
@dlt.append_flow(
    target="acmi_edw_dev.edw_bronze.currency_exchange",
    name="f_currency_exchange_bronze",
    comment="Append flow to acmi_edw_dev.edw_bronze.currency_exchange"
)
def f_currency_exchange_bronze():
    """Append flow to acmi_edw_dev.edw_bronze.currency_exchange"""
    # Streaming flow
