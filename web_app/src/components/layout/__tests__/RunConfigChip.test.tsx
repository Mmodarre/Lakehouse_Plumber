...
import { RunConfigChip } from '../Header'
...
// The chip is the always-visible run-config indicator (Header mounts it on
// every page) AND the stale-selection guard: when the files tree confirms
// the bound path is gone, the selection self-clears with a toast instead of
// wedging every future run on a 404.
