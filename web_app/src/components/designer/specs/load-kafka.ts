      ...
      fields: [
        {
          ...
          help: 'Maps to kafka.bootstrap.servers.',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          options: ['stream'],
          enumDefault: 'stream',
          help: 'Kafka is stream-only; batch is rejected.',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          label: 'Kafka options',
          widget: 'keyValue',
          help: 'Extra kafka.* options (security protocol, SASL/OAuth, startingOffsets, ...).',
        },
      ],
    },
    {
