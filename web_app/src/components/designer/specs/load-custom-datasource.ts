      ...
      fields: [
        {
          ...
          help: 'Path to the .py DataSource module.',
        },
        {
          ...
          help: 'DataSource subclass to register and read; its name() drives .format().',
        },
        {
          path: ['source', 'options'],
          label: 'Reader options',
          widget: 'keyValue',
          help: 'Passed to the reader.',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          enumDefault: 'stream',
          help: 'Custom data sources default to stream; batch is also supported.',
        },
      ],
    },
    {
