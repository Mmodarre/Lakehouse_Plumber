...
""")
        ...
        try:
            ...
            assert all(
                fg.use_template == "TMPL003_parquet_ingestion_template"
...
""")
            ...
            discoverer = FlowgroupDiscoveryService(project_root)
            flowgroups_separate = discoverer._legacy_discover_flowgroups_by_dir(
                pipelines_dir
            )
...
""")
            ...
            flowgroups_combined = discoverer._legacy_discover_flowgroups_by_dir(
                pipelines_dir
            )
