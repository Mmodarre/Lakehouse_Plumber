...
class TestTransformOperationalMetadata:
    ...
    def test_sql_transform_with_operational_metadata(
        ...
        # Alphabetical ordering — batch_id must come before processing_timestamp
    ...
    def test_temp_table_transform_with_operational_metadata(
        self, project_config_with_metadata, flowgroup_with_metadata
    ):
    ...
    def test_sql_transform_with_custom_sql_and_metadata(
        self, project_config_with_metadata, flowgroup_with_metadata
    ):
        ...
        # Metadata must be added after SQL execution
        assert "# Add operational metadata columns" in code
    ...
    def test_operational_metadata_imports(
        self, project_config_with_metadata, flowgroup_with_metadata
    ):
    ...
    def test_temp_table_with_custom_sql_and_metadata(
        self, project_config_with_metadata, flowgroup_with_metadata
    ):
