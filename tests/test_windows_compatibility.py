    ...
    def test_basic_import_without_unicode_issues(self):
        ...
        result = subprocess.run(
            [
                sys.executable,
                "-c",
                "import lhp; print('[OK] Package imports successfully')",
            ],
            capture_output=True,
            text=True,
        ...
        for message in test_messages:
            ...
            try:
                ...
                raise AssertionError(
                    f"Message '{message}' is not Windows CP1252 compatible"
                ) from e
    ...
    def test_unicode_replacement_effectiveness(self):
        ...
        for replacement in ascii_replacements:
            try:
                ...
                raise AssertionError(
                    f"ASCII replacement '{replacement}' failed encoding test"
                ) from e
