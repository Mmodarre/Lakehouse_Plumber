...
| Completed `Discovering` leaves no spinner (`..._after_discovery_completes_has_no_spinner`) | `test_live_renderer.py::test_success_path_prints_durable_seconds_free_line` + `test_failed_phase_renders_cross_on_stage_line` (permanent stage lines, not a lingering spinner) |
