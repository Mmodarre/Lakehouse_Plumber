...
class TestDQELoadExpectationsFromFile:
    ...
    def test_load_expectations_from_file_success(self, caplog):
        ...
        try:
            with caplog.at_level(logging.INFO, logger="lhp.core.processing.dqe"):
...
class TestDQEValidateExpectations:
    ...
    def test_validate_expectations_missing_constraint(self):
        ...
        expectations = [{"type": "expect", "message": "Missing constraint"}]
    ...
    def test_validate_expectations_invalid_type(self):
        ...
        expectations = [
            {"constraint": "col > 0", "type": "invalid_type", "message": "Invalid type"}
        ]
        ...
        assert (
            "Must be one of: ['expect', 'expect_or_drop', 'expect_or_fail']"
            in errors[0]
        )
