...
from lhp.core.validators import validate_job_name_format, validate_job_names
...
class TestJobNameValidationLogging:
    ...
    def test_logs_multi_job_success(self, caplog, create_flowgroup):
        ...
        caplog.set_level(logging.INFO, logger="lhp.core.validators.pipeline.job_name")
    ...
    def test_logs_single_job_mode(self, caplog, create_flowgroup):
        ...
        caplog.set_level(logging.DEBUG, logger="lhp.core.validators.pipeline.job_name")
