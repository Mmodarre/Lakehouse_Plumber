...
INTENT_CASES = [
    (
        ...
        dict(action_name="test_action", field_pairs=[("format", "cloudFiles.format")]),
        LHPConfigError,
        "LHP-CFG-001",
    ),
    (
    ...
    (
        ...
        dict(
            ...
            component_type="action",
            errors=["Missing source view", "Invalid target reference", "Unknown issue"],
        ),
        LHPValidationError,
        "LHP-VAL-002",
    ),
    ...
    (
        "preset_not_found",
        dict(preset_name="bad_preset", available_presets=["good_preset"]),
        LHPConfigError,
        "LHP-ACT-001",
    ),
]
