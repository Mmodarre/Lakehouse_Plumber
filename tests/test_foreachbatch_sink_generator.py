...
df.write.format("delta").save("${backup_path}")""",
        ...
        context = {"substitution_manager": substitution_mgr}
    ...
    def test_generate_neither_module_nor_handler_error(self):
        ...
        assert "module_path" in str(exc_info.value) or "batch_handler" in str(
            exc_info.value
        )
    ...
    def test_generate_non_string_source_error(self):
        ...
        assert (
            "single source" in str(exc_info.value).lower()
