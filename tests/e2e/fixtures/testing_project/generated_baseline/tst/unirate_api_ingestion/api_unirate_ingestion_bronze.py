...
dlt.create_streaming_table(
    name="acme_edw_tst.edw_bronze.currency_exchange",
...
@dlt.append_flow(
    target="acme_edw_tst.edw_bronze.currency_exchange",
    name="f_currency_exchange_bronze",
    comment="Append flow to acme_edw_tst.edw_bronze.currency_exchange",
)
def f_currency_exchange_bronze():
    """Append flow to acme_edw_tst.edw_bronze.currency_exchange"""
    # Streaming flow
