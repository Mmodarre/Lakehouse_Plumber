...
FROM acme_edw_tst.edw_silver.customer_dim c
JOIN acme_edw_tst.edw_silver.orders_fct o ON c.customer_id = o.customer_id
  AND o.order_date >= c.__start_at
  AND (o.order_date < c.__end_at OR c.__end_at IS NULL)
JOIN acme_edw_tst.edw_silver.nation_dim n ON c.nation_id = n.nation_id
...
def customer_lifetime_value_mv():
    """Write to acme_edw_tst.edw_gold.customer_lifetime_value_mv from multiple sources"""
