...
# FlowGroup: site_beta_customer_silver

from pyspark import pipelines as dp

# Pipeline Configuration
PIPELINE_ID = "acme_edw_bp_silver"
FLOWGROUP_ID = "site_beta_customer_silver"
...
dp.create_streaming_table(
    name="acme_edw_dev.edw_silver.site_beta_customer_dim",
    comment="Streaming table: site_beta_customer_dim",
    table_properties={"delta.enableRowTracking": "true"},
)

# Snapshot CDC mode using create_auto_cdc_from_snapshot_flow
dp.create_auto_cdc_from_snapshot_flow(
    target="acme_edw_dev.edw_silver.site_beta_customer_dim",
