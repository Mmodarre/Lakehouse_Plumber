...
def v_customer_raws():
    ...
    df = spark.readStream.table("acme_edw_prod.edw_raw.customers")
...
dp.create_streaming_table(
    name="acme_edw_prod.edw_bronze.customers",
...
@dp.append_flow(
    target="acme_edw_prod.edw_bronze.customers",
    name="f_customer_bronze",
    comment="Append flow to acme_edw_prod.edw_bronze.customers",
)
def f_customer_bronze():
    """Append flow to acme_edw_prod.edw_bronze.customers"""
    # Streaming flow
