...
from lhp.errors import ErrorCategory, LHPError, MultiDocumentError
from lhp.parsers.yaml_loader import (
...
class TestSafeLoadYAMLWithFallback:
    ...
    def test_load_missing_file_returns_fallback(self, tmp_path):
        ...
        result = safe_load_yaml_with_fallback(
            missing_file, fallback_value={"default": "value"}
        )
    ...
    def test_load_invalid_yaml_returns_fallback(self, tmp_path):
        ...
        result = safe_load_yaml_with_fallback(
            bad_file, fallback_value={"fallback": True}
        )
    ...
    def test_with_error_context(self, tmp_path, caplog):
        ...
        with caplog.at_level(logging.WARNING):
            result = safe_load_yaml_with_fallback(
                bad_file, error_context="test config file", log_errors=True
            )
