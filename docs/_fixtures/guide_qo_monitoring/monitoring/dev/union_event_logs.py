...
# ---------------------------------------------------------------------------
TARGET_TABLE = "retail_dev._meta.all_pipelines_event_log"
CHECKPOINT_BASE = "/Volumes/retail_dev/_meta/checkpoints/event_logs"
MAX_WORKERS = 10

SOURCES = [
    ("bronze_orders", "retail_dev._meta.bronze_orders_event_log"),
]
