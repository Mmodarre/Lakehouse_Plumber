...
# Pipeline: retail_edw_event_log_monitoring
...
PIPELINE_ID = "retail_edw_event_log_monitoring"
...
@dp.materialized_view(
    name="retail_dev._meta.events_summary",
    comment="Materialized view: events_summary",
    table_properties={},
)
def events_summary():
    """Write to retail_dev._meta.events_summary from multiple sources"""
    ...
    FROM retail_dev._meta.all_pipelines_event_log
