...
# ---------------------------------------------------------------------------
TARGET_TABLE = "main._meta.all_pipelines_event_log"
CHECKPOINT_BASE = "/Volumes/main/_meta/checkpoints"
MAX_WORKERS = 10

SOURCES = [
    ("sample_gold", "main._meta.sample_gold_event_log"),
    ("sample_ingest", "main._meta.sample_ingest_event_log"),
    ("sample_silver", "main._meta.sample_silver_event_log"),
]
