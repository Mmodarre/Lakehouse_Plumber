...
# Pipeline: sample_lakehouse_event_log_monitoring
...
PIPELINE_ID = "sample_lakehouse_event_log_monitoring"
...
@dp.materialized_view(
    name="main._meta.events_summary",
    comment="Materialized view: events_summary",
    table_properties={},
)
def events_summary():
    """Write to main._meta.events_summary from multiple sources"""
    ...
    FROM main._meta.all_pipelines_event_log
