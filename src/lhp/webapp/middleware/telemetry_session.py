...
ROUTE_FAMILIES: dict[tuple[str, str], str] = {
    ...
    ("GET", "/templates/catalog"): "templates.read",
    ("GET", "/templates/source"): "templates.read",
    ("GET", "/templates/{name}"): "templates.read",
    ("POST", "/templates/preview"): "templates.preview",
    ...
    ("GET", "/configuration/preview"): "configuration.preview",
    ("GET", "/help/{kind}"): "help.read",
