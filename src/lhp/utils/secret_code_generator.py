...
class SecretCodeGenerator:
    ...
    def _build_placeholder_mapping(self, secret_refs: Set[SecretReference]) -> Dict[str, SecretReference]:
    ...
    def _process_string_literal(self, match, placeholder_to_secret: Dict[str, SecretReference]) -> str:
        ...
        return self._convert_to_fstring(string_content, placeholders_in_string, quote_char)
    ...
    def _generate_dbutils_call(self, secret_ref: SecretReference, quote_char: str) -> str:
    ...
    def _convert_to_fstring(self, string_content: str, placeholders: List[Tuple[str, SecretReference]], quote_char: str) -> str:
