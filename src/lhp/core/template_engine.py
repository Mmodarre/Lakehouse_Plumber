...
class TemplateEngine:
    ...
    def _load_templates(self):
        ...
        self.logger.info(f"Loading {len(template_files)} templates from {self.templates_dir}")
    ...
    def render_template(self, template_name: str, parameters: Dict[str, Any]) -> List[Action]:
    ...
    def _apply_parameter_defaults(self, template: TemplateModel, parameters: Dict[str, Any]) -> Dict[str, Any]:
