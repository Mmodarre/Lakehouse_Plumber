...
from ..models.config import FlowGroup, Action
...
class NotebookInterface:
    ...
    def __init__(self, project_root: Union[str, Path] = None):
        ...
        self.logger.info(f"Initialized LakehousePlumber notebook interface with project root: {self.project_root}")
    ...
    def generate_pipeline(self, 
        ...
        try:
            ...
            result = {
                ...
                'output_directory': str(output_path / pipeline_name) if not dry_run else None,
                'dry_run': dry_run,
    ...
    def generate_all_pipelines(self, env: str = "dev", dry_run: bool = False) -> Dict[str, Any]:
    ...
    def _print_validation_results(self, result: Dict[str, Any]):
        ...
        if result['valid']:
            ...
            print(f"❌ Pipeline '{pipeline}' has validation errors for environment '{env}'")
    ...
    def _print_generation_results(self, result: Dict[str, Any]):
        ...
        if result['success']:
            ...
            print(f"❌ Failed to generate pipeline '{pipeline}' for environment '{env}'")
...
def quick_generate(pipeline_name: str, env: str = "dev", project_root: Union[str, Path] = None) -> Dict[str, Any]:
...
def quick_validate(pipeline_name: str, env: str = "dev", project_root: Union[str, Path] = None) -> Dict[str, Any]:
