...
class WidgetInterface:
    ...
    def create_pipeline_widgets(self, 
    ...
    def create_multi_pipeline_widgets(self):
        ...
        try:
            ...
            print("📝 Use the widgets above to configure your multi-pipeline generation")
    ...
    def generate_all_from_widgets(self) -> Dict[str, Any]:
        ...
        """
        if not self.widgets_created:
            print("❌ Widgets not created yet. Run create_multi_pipeline_widgets() first.")
            return {'success': False, 'error': 'Widgets not created'}
...
def quick_widget_setup(project_root: Union[str, Path] = None, 
                      default_pipeline: str = None, 
                      default_env: str = "dev"):
